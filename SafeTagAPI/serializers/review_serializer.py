...
class ReviewPathologieSerializer(serializers.ModelSerializer):
    id_pathologie = serializers.PrimaryKeyRelatedField(queryset=Pathologie.objects.all())
...
class ReviewSerializer(serializers.ModelSerializer):
    ...
    id_address = serializers.PrimaryKeyRelatedField(queryset=Practitioner_Address.objects.none())

    class Meta:
        model = Review
        fields = ['review_date', 'comment', 'id_user', 'id_practitioners', 'pathologies', 'tags', 'id_address']
    ...
    def __init__(self, *args, **kwargs):
        ...
        if practitioner_id:
            try:
                ...
                self.fields['id_address'].queryset = practitioner_instance.addresses.all()
