...
from ..models.practitioner_model import Practitioners, Professional_Tag_Score, Practitioner_Address, Organization

class PractitionerAddressSerializer(serializers.ModelSerializer):
    class Meta:
        model = Practitioner_Address
        fields = ['line', 'city', 'department', 'latitude', 'longitude', 'wheelchair_accessibility']
...
class PractitionerSerializer(serializers.ModelSerializer):
    ...
    def update(self, instance, validated_data):
        ...
        instance.reimboursement_sector = validated_data.get('reimboursement_sector', instance.reimboursement_sector)
        instance.save()
